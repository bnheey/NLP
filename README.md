...
🌱 각각의 Day는 이론과 실습, 과제의 결과물로 구성되어 있으며, 📝는 과제를 의미한다. 과제는 자연어처리 이론 및 자연어처리 모델 실습 / 응용 예제 실습 등 으로 이루어져있다.

🌻 학습은 자연어처리 이론을 이해하고 바로 실습해보는 체감형 학습 방법으로 진행한다.
🌻 응용프로그램 실습을 통해 자연어처리 개발 능력을 내제화한다.
